...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<?php // function_exists used for versions of WP that don't use get_avatar (e.g. 2.3)
			...
			<small class="commentmetadata"><a href="<?php echo paged_comments_url('comment-'.get_comment_ID()); ?>" title=""><?php comment_date('F jS, Y') ?> at <?php comment_time() ?></a> <?php edit_comment_link('edit','&nbsp;&nbsp;',''); ?></small>
