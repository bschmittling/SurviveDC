...
//$message = "Thank you for testing the SurviveDC App! Since this is just a test, assume your catch report will be removed on the night of the event so we can start fresh.";
$photo = $_FILES['photo'];
